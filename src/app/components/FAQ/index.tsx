...
const FAQ = () => {
    return (
        <Accordion>
            ...
            >
                <p>
                    Our goal is to keep the executive retreat fresh and fun each
                    year. The Boca Raton Beach Club resort is a beachside
                    paradise with myriad opportunities for relaxation,
            ...
            >
                <p>
                    ...
                    previous years including VIP guests, engaging conversations,
                    high-touch networking, group activities, fabulous dinners,
                    and, as always, plenty of fun.
                </p>
            </AccordionItem>
            <AccordionItem
            ...
            >
                <p>
                    Attendees can anticipate the same VIP treatment and quality
                    content as in previous years. We aim for this to be a
                    distinguished experience featuring excellent programming,
                    exceptional dinners, a variety of activities, valuable
                    networking opportunities, and some unexpected elements.
                </p>
            </AccordionItem>
            <AccordionItem
            ...
            >
                <p>
                    Guests will have the opportunity to enjoy multiple pools,
                    golf, tennis, pickleball, workouts, water sports, and
                    luxurious spa facilities. Our team is happy to help
                    facilitate activities, which we will share in more detail
                    closer to the event.
                </p>
            </AccordionItem>
            <AccordionItem
            ...
            >
                <p>
                    The Boca Raton, conveniently situated between Palm Beach and
                    Miami, offers excellent accessibility through three
                    international airports (FLL, PBI, and MIA), as well as Boca
                    Raton Airport.
                </p>
                <p>
                    Upon arrival, you will have ground transportation arranged
                    on your behalf (at guest’s expense).
                </p>
                <br />
                <strong>Airport transport times:</strong>
                <ul>
                    <li>FLL (24 miles / 30-35 min)</li>
                    <li>PBI (28 miles / 35-40 min, also a private jet hub)</li>
            ...
            >
                <p>
                    As always, it&apos;s our goal to enhance the experience for
                    guests. We have secured a discounted rate with the
            ...
            >
                <p>
                    ...
                    transportation and non-event activities (e.g. spa services,
                    room service) will be arranged for you at your own cost.
                    Access to the amenities and activity programming of The Boca
                    Raton Club are also included.{' '}
                    <a
                ...
                <ul>
                    ...
                    <li>In-room minibar with water, sodas, beer, and snacks</li>
                    <li>
            ...
            >
                <p>
                    Of course! We can help you work directly with the hotel, and
                    have secured a special rate for all of our guests the three
                    nights prior to and post event. (March 15, 16, 17, 20, 21,
                    22). Your room cost (excluding incidental expenses) for the
                    nights of the event - March 18 and March 19, 2026 will be
                    fully covered by the event.
                </p>
            </AccordionItem>
            ...
            >
                <p>
                    Yes, we encourage you to bring a spouse / partner for the 3
                    days. There will be a spouse / partner lunch and all guests
                    are invited to content, activities, and meals.
                </p>
            </AccordionItem>
        </Accordion>
    )
