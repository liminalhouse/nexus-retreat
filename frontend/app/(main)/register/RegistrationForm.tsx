...
import type {RegistrationFormConfig} from './types'
...
export default function RegistrationForm({config}: RegistrationFormProps) {
  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-nexus-navy-dark px-4">
        <div className="w-full max-w-2xl bg-white rounded-lg p-8 md:p-12">
          ...
          <div className="text-center">
            ...
            <Link
              href="/"
              className="inline-block bg-nexus-navy-dark text-white py-3 px-8 rounded-md hover:bg-nexus-navy transition-all font-medium"
            >
    ...
    <div className="min-h-screen bg-nexus-navy-dark py-8 px-4">
      <div className="w-full max-w-2xl mx-auto bg-white rounded-lg shadow-xl">
        <div className="p-6 md:p-8">
          ...
          <Link
            href="/"
            className="inline-flex items-center text-nexus-navy hover:text-nexus-navy-dark text-sm mb-6 transition-colors"
          >
            ← {config.backToHomeText || 'BACK TO HOME'}
          </Link>
          ...
          <div className="text-center mb-8">
            ...
            {config.eventDate && <p className="text-gray-600">{config.eventDate}</p>}
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-between mt-8">
              ...
              {currentStep === totalSteps - 1 ? (
                ...
                >
                  {isSubmitting ? 'Submitting...' : config.submitButtonText || 'REGISTER'}
                </button>
              ) : (
                <button
                  type="button"
